!function (e) {
    ...
    e((function () {
        ...
        e(document).on("click", "[data-lightbox]", lity.options("template", '<div class="lity" role="dialog" aria-label="Dialog Window (Press escape to close)" tabindex="-1"><div class="lity-wrap" data-lity-close role="document"><div class="lity-loader" aria-hidden="true">ng...</div><div class="lity-container"><div class="lity-content"></div><div class="lity-close" data-lity-close aria-label="Close (Press escape to close)"><span class="btn-line"></span></div></div></div></div>')),
            function (t) {
                function i(t, i, a) {
                    ...
                    setTimeout((function () {
                        emailjs.send("service_frxazyg", "template_lgwiaow", templateParams)
                            .then(function (response) {
                                ...
                                o.addClass("error").html("Failed to send message. Please try again.").fadeIn(200);
